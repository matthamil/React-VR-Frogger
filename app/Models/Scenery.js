  ...
  render() {
    return (
      <View>
        ...
        <Model
          style={{
            transform: [{ rotateY: "45deg" }, { translate: [-12.5, -10, -6.5] }]
          }}
          source={{
            obj: asset("nature/naturePack_062.obj"),
            mtl: asset("nature/naturePack_062.mtl")
